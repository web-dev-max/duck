...
//
//             jest.spyOn(authService, 'generateTokensAndCreateSession').mockResolvedValue({
//                 accessToken,
//                 refreshToken,
//             });
//
...
//                 verificationExpires: expect.any(Date),
//             });
//             expect(authService.generateTokensAndCreateSession).toHaveBeenCalledWith({
//                 id: user.id,
//                 role: user.role,
//             });
//             expect(result).toEqual({
...
//
//             jest.spyOn(authService, 'generateTokensAndCreateSession').mockRejectedValue(
...
//
//             const result = await authService.generateTokensAndCreateSession(userPayload);
//
...
//
//             await expect(authService.generateTokensAndCreateSession(userPayload)).rejects.toThrow(
//                 Error,
//             );
